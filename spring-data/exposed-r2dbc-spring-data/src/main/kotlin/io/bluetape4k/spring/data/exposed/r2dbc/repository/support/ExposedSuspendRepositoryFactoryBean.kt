 ...
 *
 * R2DBC 트랜잭션은 [SimpleExposedSuspendRepository] 내부의 Exposed `suspendTransaction` 이
 * 직접 관리합니다. Spring 의 트랜잭션 인터셉터를 적용하지 않습니다.
 */
class ExposedSuspendRepositoryFactoryBean<T : Repository<E, ID>, E : Any, ID : Any>(
    ...
    override fun createRepositoryFactory(): RepositoryFactorySupport =
        ExposedSuspendRepositoryFactory()
}
