...
import io.bluetape4k.spring.data.exposed.r2dbc.repository.support.SuspendExposedRepositoryFactoryBean
 ...
 * @EnableSuspendExposedRepositories(basePackages = ["io.example.repository"])
 * class Application
 * ```
 */
...
@MustBeDocumented
@Import(SuspendExposedRepositoriesRegistrar::class)
annotation class EnableSuspendExposedRepositories(
    vararg val value: String = [],
    val basePackages: Array<String> = [],
    val basePackageClasses: Array<KClass<*>> = [],
    val excludeFilters: Array<ComponentScan.Filter> = [],
    val includeFilters: Array<ComponentScan.Filter> = [],
    val repositoryFactoryBeanClass: KClass<*> = SuspendExposedRepositoryFactoryBean::class,
