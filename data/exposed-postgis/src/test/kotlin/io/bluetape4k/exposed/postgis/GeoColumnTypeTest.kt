...
class GeoColumnTypeTest : AbstractExposedTest() {
    ...
    fun `ST_Area - 큰 폴리곤이 작은 폴리곤보다 넓이가 크다`() {
        ...
        val large = rectanglePolygon(minLng = 125.0, minLat = 36.0, maxLng = 129.0, maxLat = 40.0)  // 4×4도
        val small = rectanglePolygon(minLng = 126.0, minLat = 37.0, maxLng = 127.0, maxLat = 38.0)  // 1×1도
