...
- Compression is not free. For this object graph, `Deflate`, `GZip`, `Zstd`, and especially `BZip2` buy smaller payloads at very large latency cost.
...
If you need compression too, choose `Fory + Snappy` first, and consider `Fory + LZ4` when you want a slightly faster large-payload path.

If the main objective is minimizing bytes on the wire, use `Kryo + Deflate` for small/medium graphs and `Kryo + Zstd` for large graphs.

## Raw Artifacts

- Perf JSON: [`combo-jmh-results.json`](/Users/debop/work/bluetape4k/bluetape4k-experimental/io/benchmarks/build/reports/benchmarks/combo-jmh-results.json)
- GC JSON: [`combo-jmh-gc-results.json`](/Users/debop/work/bluetape4k/bluetape4k-experimental/io/benchmarks/build/reports/benchmarks/combo-jmh-gc-results.json)
- Size JSON: [`combo-serialized-size.json`](/Users/debop/work/bluetape4k/bluetape4k-experimental/io/benchmarks/build/reports/benchmarks/combo-serialized-size.json)
