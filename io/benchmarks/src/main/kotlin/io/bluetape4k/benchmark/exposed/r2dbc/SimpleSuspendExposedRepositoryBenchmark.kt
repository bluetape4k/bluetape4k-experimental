...
import io.bluetape4k.spring.data.exposed.r2dbc.repository.support.SimpleSuspendExposedRepository
...
/**
 * `SimpleSuspendExposedRepository` 핵심 CRUD/paging 경로의 비용을 측정합니다.
 *
...
private fun newRepository(): SimpleSuspendExposedRepository<BenchmarkUser, Long> =
    SimpleSuspendExposedRepository(
...
open class SimpleSuspendExposedRepositoryReadBenchmark {

    @Param("100", "1000")
    var datasetSize: Int = 100

    private lateinit var repository: SimpleSuspendExposedRepository<BenchmarkUser, Long>
...
@BenchmarkMode(Mode.AverageTime)
@OutputTimeUnit(TimeUnit.MICROSECONDS)
open class SimpleSuspendExposedRepositoryWriteBenchmark {
